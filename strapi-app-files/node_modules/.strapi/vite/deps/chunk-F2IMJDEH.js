...
import {
  ...
  useGetLocalesQuery
} from "./chunk-S4PORFAF.js";
import {
  PERMISSIONS as PERMISSIONS5,
  ReleaseActionMenu,
  ReleaseActionOptions,
  pluginId as pluginId4
} from "./chunk-AJYHQOGL.js";
import {
  index
} from "./chunk-RQHYDXZB.js";
import {
  getTimezoneOffset,
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-MVWWG7IR.js";
import {
  useConfig
} from "./chunk-LRJLQXXH.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-MG6Y53BI.js";
import {
  useDocumentActions
} from "./chunk-TW3VHSMT.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-F5O3TD2V.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  renderAdmin
} from "./chunk-PUPBGM4J.js";
import {
  useLicenseLimits
} from "./chunk-VMNGXVY5.js";
import {
  require_omit
...
import {
  useRBAC
} from "./chunk-BRN7ZBVU.js";
import {
  useAdminUsers
} from "./chunk-JAYYPQ33.js";
import {
  ForwardRef$J,
  Page,
  useAPIErrorHandler
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-R3JC3E4V.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-YEMR3EMH.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-ZVH2DMB2.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-OVJCB4QB.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-AKWERA36.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-VKGJUUAP.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-2RWDI3PH.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-AMMKGUN7.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-26C4LCCN.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-B2P4ADI4.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-I37UD4CN.js");
          return {
...
//# sourceMappingURL=chunk-F2IMJDEH.js.map
